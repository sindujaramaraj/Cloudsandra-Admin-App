...
CloudsandraApi.prototype.setUsername = function(username) {
	simpleRestClient.username = username;
}

CloudsandraApi.prototype.setPassword = function(password) {
	simpleRestClient.password = password;
}
